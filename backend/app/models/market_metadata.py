...
class MarketMetadataSnapshot(Base):
    ...
    provider_requested: Mapped[str] = mapped_column(String(32), default="auto")
    provider_used: Mapped[str] = mapped_column(String(32), default="yfinance")
    fetch_start_date: Mapped[str | None] = mapped_column(String(32))
    fetch_end_date: Mapped[str | None] = mapped_column(String(32))
